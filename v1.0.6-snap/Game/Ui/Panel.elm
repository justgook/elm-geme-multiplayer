module Game.Ui.Panel exposing (Options, panel, spriteRender)

import Game.Ui.Internal exposing (defaultEntitySettings, mesh)
...
type alias Options =
    ...
    , slice : { x : Float, y : Float, w : Float, h : Float }
    }


panel : String -> Options -> Float -> Float -> Shape2d
panel atlas { bounds, slice } w h =
...
spriteRender uv2 image_ imageSize uv uP uT z opacity =
    WebGL.entityWith
        defaultEntitySettings
        vertSprite
        fragSprite
